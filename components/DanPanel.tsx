...
export default function DnaPanel() {
  return (
    ...
    <div className="font-inter w-[300px] bg-black text-white flex flex-col shadow-2xl relative z-10 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto py-2 mt-4 min-h-0 no-scrollbar flex flex-col">
        ...
        {/* Text Input Area */}
        <div className="relative group flex-1 min-h-[60px] flex flex-col mb-3">
          <textarea
            ...
            spellCheck={false}
          ></textarea>
           <div className="absolute bottom-3 right-3 pointer-events-none opacity-30 group-hover:opacity-60 transition-opacity">
             <svg width="5" height="5" viewBox="0 0 12 12" fill="none" stroke="#a1a1aa"><path d="M10.5 1.5V10.5H1.5" strokeWidth="2" strokeLinecap="round"/></svg>
           </div>
        </div>
      ...
      {/* 4. FOOTER */}
      <div className="px-5  py-4 mt-8 shrink-0 bg-black z-20">
