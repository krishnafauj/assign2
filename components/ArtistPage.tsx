...
// --- Data for the cards (matching your screenshot) ---
const CARDS_DATA = [
  {
    title: "Dubstep",
    ...
    active: true // The first one looks selected in screenshot
  },
  {
    title: "Big Room",
...
const StyleCard = ({ data }: { data: typeof CARDS_DATA[0] }) => {
  return (
